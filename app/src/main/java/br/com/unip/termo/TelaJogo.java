...
public class TelaJogo extends AppCompatActivity {
    ...
    TextView palavraDica;
    TextView numFase;
    TextView numPalavra;
    Button btnProx2;
    private int linha = 1;
    private int fase;
    private int palavra = 1;
    private String palavraSorteada = "";
    private List<String> letrasSeparadas = new ArrayList<>();
    ...
    private String palavraComAcento = "";
    private String palavraDaDica = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("palavra")) {
            palavra = getIntent().getIntExtra("palavra",palavra);
            fase = getIntent().getIntExtra("fase",1);
        } else if (getIntent().hasExtra("fase")) {
            fase = getIntent().getIntExtra("fase",1);
        }

        letrasSeparadas.clear();
        Palavras p = null;

        switch (fase){
            case 2:
                palavraComAcento = "Águas";
                break;
            case 4:
                palavraComAcento = "Fauna";
                break;
            case 6:
                palavraComAcento = "Flora";
                break;
            default:
                try {
                    p = new Palavras(this);
                    //palavraComAcento = p.sortearPalavras();
                    palavraComAcento = "cinza";
                } catch (IOException e) {
        ...
        dividirLetras(palavraComAcento);

        sortearDica();

        numFase = findViewById(R.id.numFase);
        numFase.setText(String.valueOf(fase));
        numPalavra = findViewById(R.id.numPalavra);
        numPalavra.setText(String.valueOf(palavra));
    }
    ...
    void sortearDica(){
        ...
        if (fase < 3){
            while (contador != 3) {
                numSorteado = random.nextInt(4);
                if (!nums.contains(numSorteado)){
        ...
        for (int i = 0; i <= letrasSeparadas.size() - 1; i++){
            if (nums.contains(i)){
                palavraDaDica = palavraDaDica + letrasSeparadas.get(i);
            } else {
                palavraDaDica = palavraDaDica + "_";
            }
        }

        palavraDica = findViewById(R.id.palavraDica);
        palavraDica.setText(palavraDaDica);

        if (fase > 5){
            palavraDica.setVisibility(View.INVISIBLE);
        }
    }

    void dividirLetras(String palavra){
        for (int i = 0; i < 5; i++){
            letrasSeparadas.add(palavra.substring(i,i+1).toUpperCase());
        }

        verificarAcentuacao();

        for (int i = 0; i < 5; i++) {
            palavraSorteada += letrasSeparadas.get(i);
        }
    }

    void verificarAcentuacao(){
        for (int i = 0; i < 5; i ++){
            switch (letrasSeparadas.get(i)){
                case "Á":
                    letrasSeparadas.set(i,"A");
                    break;
                case "Ã":
                    letrasSeparadas.set(i, "A");
                    break;
                case "Â":
                    ...
                    break;
                case "É":
                    letrasSeparadas.set(i, "E");
                    break;
                case "Ê":
                    letrasSeparadas.set(i, "E");
                    break;
                case "Í":
                    letrasSeparadas.set(i, "I");
                    break;
                case "Î":
                    letrasSeparadas.set(i, "I");
                    break;
                case "Ó":
                    letrasSeparadas.set(i, "O");
                    break;
                case "Õ":
                    letrasSeparadas.set(i, "O");
                    break;
                case "Ô":
                    ...
                    break;
                case "Ú":
                    letrasSeparadas.set(i, "U");
                    break;
                case "Û":
                    letrasSeparadas.set(i, "U");
                    break;
                case "Ç":
                    letrasSeparadas.set(i, "C");
                    break;
            }
        }
    }
            ...
            switch (linha){
                case 1:
                    if (linha1letra5.getText().equals("")){
                        ...
                        textoInformacao.setText("A palavra está incompleta. A palavra precisa ter 5 letras.");
                        textoInformacao.setBackgroundResource(R.drawable.forma_errada);
                        btnProx2 = findViewById(R.id.btnProx2);
                        btnProx2.setVisibility(View.VISIBLE);
                        btnProx2.setText("Continuar");
                    } else {
                        ...
                        if (palavraFormada.equals(palavraSorteada.toUpperCase())){
                            ...
                            textoInformacao = findViewById(R.id.textoInformacao);
                            textoInformacao.setVisibility(View.VISIBLE);
                            textoInformacao.setText("PARABÉNS!!! Você acertou a palavra. Pronto para a próxima?");
                            ...
                            btnProx2 = findViewById(R.id.btnProx2);
                            btnProx2.setVisibility(View.INVISIBLE);

                            if(linha1letra1.getText().equals(letrasSeparadas.get(0))){
                                linha1letra1.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha1letra1);
                                letrasPosCerta2.add(linha1letra1.getText().toString());
                            } else if (letrasSeparadas.contains(linha1letra1.getText())){
                            ...
                            if(linha1letra2.getText().equals(letrasSeparadas.get(1))){
                                linha1letra2.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha1letra2);
                                letrasPosCerta2.add(linha1letra2.getText().toString());
                            } else if (letrasSeparadas.contains(linha1letra2.getText())){
                            ...
                            if(linha1letra3.getText().equals(letrasSeparadas.get(2))){
                                linha1letra3.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha1letra3);
                                letrasPosCerta2.add(linha1letra3.getText().toString());
                            } else if (letrasSeparadas.contains(linha1letra3.getText())){
                            ...
                            if(linha1letra4.getText().equals(letrasSeparadas.get(3))){
                                linha1letra4.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha1letra4);
                                letrasPosCerta2.add(linha1letra4.getText().toString());
                            } else if (letrasSeparadas.contains(linha1letra4.getText())){
                            ...
                            if(linha1letra5.getText().equals(letrasSeparadas.get(4))){
                                linha1letra5.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha1letra5);
                                letrasPosCerta2.add(linha1letra5.getText().toString());
                            } else if (letrasSeparadas.contains(linha1letra5.getText().toString())){
                            ...
                            segundaVerificacao(linha1letra1);
                            segundaVerificacao(linha1letra2);
                            segundaVerificacao(linha1letra3);
                            segundaVerificacao(linha1letra4);
                            segundaVerificacao(linha1letra5);
                            pintarTeclado();
                            letraNExiste.clear();
                ...
                case 2:
                    if (linha2letra5.getText().equals("")){
                        ...
                        if (palavraFormada.equals(palavraSorteada.toUpperCase())){
                            ...
                            if(linha2letra1.getText().equals(letrasSeparadas.get(0))){
                                linha2letra1.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha2letra1);
                                letrasPosCerta2.add(linha2letra1.getText().toString());
                            } else if (letrasSeparadas.contains(linha2letra1.getText())){
                            ...
                            if(linha2letra2.getText().equals(letrasSeparadas.get(1))){
                                linha2letra2.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha2letra2);
                                letrasPosCerta2.add(linha2letra2.getText().toString());
                            } else if (letrasSeparadas.contains(linha2letra2.getText())){
                            ...
                            if(linha2letra3.getText().equals(letrasSeparadas.get(2))){
                                linha2letra3.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha2letra3);
                                letrasPosCerta2.add(linha2letra3.getText().toString());
                            } else if (letrasSeparadas.contains(linha2letra3.getText())){
                            ...
                            if(linha2letra4.getText().equals(letrasSeparadas.get(3))){
                                linha2letra4.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha2letra4);
                                letrasPosCerta2.add(linha2letra4.getText().toString());
                            } else if (letrasSeparadas.contains(linha2letra4.getText())){
                            ...
                            if(linha2letra5.getText().equals(letrasSeparadas.get(4))){
                                linha2letra5.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha2letra5);
                                letrasPosCerta2.add(linha2letra5.getText().toString());
                            } else if (letrasSeparadas.contains(linha2letra5.getText().toString())){
                            ...
                            segundaVerificacao(linha2letra1);
                            segundaVerificacao(linha2letra2);
                            segundaVerificacao(linha2letra3);
                            segundaVerificacao(linha2letra4);
                            segundaVerificacao(linha2letra5);
                            pintarTeclado();
                            letraNExiste.clear();
                            letraPosErrada.clear();
                            letrasPosCerta2.clear();
                ...
                case 3:
                    if (linha3letra5.getText().equals("")){
                        ...
                        if (palavraFormada.equals(palavraSorteada.toUpperCase())){
                            ...
                            if(linha3letra1.getText().equals(letrasSeparadas.get(0))){
                                linha3letra1.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha3letra1);
                                letrasPosCerta2.add(linha3letra1.getText().toString());
                            } else if (letrasSeparadas.contains(linha3letra1.getText())){
                            ...
                            if(linha3letra2.getText().equals(letrasSeparadas.get(1))){
                                linha3letra2.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha3letra2);
                                letrasPosCerta2.add(linha3letra2.getText().toString());
                            } else if (letrasSeparadas.contains(linha3letra2.getText())){
                            ...
                            if(linha3letra3.getText().equals(letrasSeparadas.get(2))){
                                linha3letra3.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha3letra3);
                                letrasPosCerta2.add(linha3letra3.getText().toString());
                            } else if (letrasSeparadas.contains(linha3letra3.getText())){
                            ...
                            if(linha3letra4.getText().equals(letrasSeparadas.get(3))){
                                linha3letra4.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha3letra4);
                                letrasPosCerta2.add(linha3letra4.getText().toString());
                            } else if (letrasSeparadas.contains(linha3letra4.getText())){
                            ...
                            if(linha3letra5.getText().equals(letrasSeparadas.get(4))){
                                linha3letra5.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha3letra5);
                                letrasPosCerta2.add(linha3letra5.getText().toString());
                            } else if (letrasSeparadas.contains(linha3letra5.getText().toString())){
                            ...
                            segundaVerificacao(linha3letra1);
                            segundaVerificacao(linha3letra2);
                            segundaVerificacao(linha3letra3);
                            segundaVerificacao(linha3letra4);
                            segundaVerificacao(linha3letra5);
                            pintarTeclado();
                            letraNExiste.clear();
                            letraPosErrada.clear();
                            letrasPosCerta2.clear();
                ...
                case 4:
                    if (linha4letra5.getText().equals("")){
                        ...
                        if (palavraFormada.equals(palavraSorteada.toUpperCase())){
                            ...
                            if(linha4letra1.getText().equals(letrasSeparadas.get(0))){
                                linha4letra1.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha4letra1);
                                letrasPosCerta2.add(linha4letra1.getText().toString());
                            } else if (letrasSeparadas.contains(linha4letra1.getText())){
                            ...
                            if(linha4letra2.getText().equals(letrasSeparadas.get(1))){
                                linha4letra2.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha4letra2);
                                letrasPosCerta2.add(linha4letra2.getText().toString());
                            } else if (letrasSeparadas.contains(linha4letra2.getText())){
                            ...
                            if(linha4letra3.getText().equals(letrasSeparadas.get(2))){
                                linha4letra3.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha4letra3);
                                letrasPosCerta2.add(linha4letra3.getText().toString());
                            } else if (letrasSeparadas.contains(linha4letra3.getText())){
                            ...
                            if(linha4letra4.getText().equals(letrasSeparadas.get(3))){
                                linha4letra4.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha4letra4);
                                letrasPosCerta2.add(linha4letra4.getText().toString());
                            } else if (letrasSeparadas.contains(linha4letra4.getText())){
                            ...
                            if(linha4letra5.getText().equals(letrasSeparadas.get(4))){
                                linha4letra5.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha4letra5);
                                letrasPosCerta2.add(linha4letra5.getText().toString());
                            } else if (letrasSeparadas.contains(linha4letra5.getText().toString())){
                            ...
                            segundaVerificacao(linha4letra1);
                            segundaVerificacao(linha4letra2);
                            segundaVerificacao(linha4letra3);
                            segundaVerificacao(linha4letra4);
                            segundaVerificacao(linha4letra5);
                            pintarTeclado();
                            letraNExiste.clear();
                            letraPosErrada.clear();
                            letrasPosCerta2.clear();
                ...
                case 5:
                    if (linha5letra5.getText().equals("")){
                        ...
                        if (palavraFormada.equals(palavraSorteada.toUpperCase())){
                            ...
                            if(linha5letra1.getText().equals(letrasSeparadas.get(0))){
                                linha5letra1.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha5letra1);
                                letrasPosCerta2.add(linha5letra1.getText().toString());
                            } else if (letrasSeparadas.contains(linha5letra1.getText())){
                            ...
                            if(linha5letra2.getText().equals(letrasSeparadas.get(1))){
                                linha5letra2.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha5letra2);
                                letrasPosCerta2.add(linha5letra2.getText().toString());
                            } else if (letrasSeparadas.contains(linha5letra2.getText())){
                            ...
                            if(linha5letra3.getText().equals(letrasSeparadas.get(2))){
                                linha5letra3.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha5letra3);
                                letrasPosCerta2.add(linha5letra3.getText().toString());
                            } else if (letrasSeparadas.contains(linha5letra3.getText())){
                            ...
                            if(linha5letra4.getText().equals(letrasSeparadas.get(3))){
                                linha5letra4.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha5letra4);
                                letrasPosCerta2.add(linha5letra4.getText().toString());
                            } else if (letrasSeparadas.contains(linha5letra4.getText())){
                            ...
                            if(linha5letra5.getText().equals(letrasSeparadas.get(4))){
                                linha5letra5.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha5letra5);
                                letrasPosCerta2.add(linha5letra5.getText().toString());
                            } else if (letrasSeparadas.contains(linha5letra5.getText().toString())){
                            ...
                            segundaVerificacao(linha5letra1);
                            segundaVerificacao(linha5letra2);
                            segundaVerificacao(linha5letra3);
                            segundaVerificacao(linha5letra4);
                            segundaVerificacao(linha5letra5);
                            pintarTeclado();
                            letraNExiste.clear();
                            letraPosErrada.clear();
                            letrasPosCerta2.clear();
                ...
                case 6:
                    if (linha6letra5.getText().equals("")){
                        ...
                        if (palavraFormada.equals(palavraSorteada.toUpperCase())){
                            ...
                            if(linha6letra1.getText().equals(letrasSeparadas.get(0))){
                                linha6letra1.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha6letra1);
                                letrasPosCerta2.add(linha6letra1.getText().toString());
                            } else if (letrasSeparadas.contains(linha6letra1.getText())){
                            ...
                            if(linha6letra2.getText().equals(letrasSeparadas.get(1))){
                                linha6letra2.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha6letra2);
                                letrasPosCerta2.add(linha6letra2.getText().toString());
                            } else if (letrasSeparadas.contains(linha6letra2.getText())){
                            ...
                            if(linha6letra3.getText().equals(letrasSeparadas.get(2))){
                                linha6letra3.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha6letra3);
                                letrasPosCerta2.add(linha6letra3.getText().toString());
                            } else if (letrasSeparadas.contains(linha6letra3.getText())){
                            ...
                            if(linha6letra4.getText().equals(letrasSeparadas.get(3))){
                                linha6letra4.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha6letra4);
                                letrasPosCerta2.add(linha6letra4.getText().toString());
                            } else if (letrasSeparadas.contains(linha6letra4.getText())){
                            ...
                            if(linha6letra5.getText().equals(letrasSeparadas.get(4))){
                                linha6letra5.setBackgroundResource(R.drawable.letra_certa);
                                letrasPosCerta.add(linha6letra5);
                                letrasPosCerta2.add(linha6letra5.getText().toString());
                            } else if (letrasSeparadas.contains(linha6letra5.getText().toString())){
                            ...
                            segundaVerificacao(linha6letra1);
                            segundaVerificacao(linha6letra2);
                            segundaVerificacao(linha6letra3);
                            segundaVerificacao(linha6letra4);
                            segundaVerificacao(linha6letra5);
                            pintarTeclado();
                            letraNExiste.clear();
                            letraPosErrada.clear();
                            letrasPosCerta2.clear();
                            ...
                            textoInformacao = findViewById(R.id.textoInformacao);
                            textoInformacao.setVisibility(View.VISIBLE);
                            textoInformacao.setText("Puxa vida, você perdeu!. A palavra era:" + palavraComAcento + ". Mas não desanime, tente novamente ;)");
                            textoInformacao.setBackgroundResource(R.drawable.forma_errada);

                            btnProx2 = findViewById(R.id.btnProx2);
                            btnProx2.setVisibility(View.VISIBLE);
                            btnProx2.setText("Tentar Novamente");
                        }
                    } break;
            }
        }
    ...
    void segundaVerificacao(TextView linhaLetra){
        int num = 0;
        if(contarLetras(linhaLetra.getText(), letrasSeparadas) == 1){
        ...
        } else if (contarLetras(linhaLetra.getText(), letrasSeparadas) == 2) {
            if (letraPosErrada.contains(linhaLetra)){
        ...
        } else if (contarLetras(linhaLetra.getText(), letrasSeparadas) == 3) {
            if (letraPosErrada.contains(linhaLetra)){
                for(String l: letrasPosCerta2){
                    if (l.equals(linhaLetra.getText())){
                        num+=1;
    ...
    public void btnProx2(View v){
        if (v.getId() == R.id.btnProx2){
            switch (btnProx2.getText().toString()){
    ...
    void tentarNovamente(){
        Intent telaJogo = getIntent();
        telaJogo.putExtra("palavra",palavra);
        finish();
        startActivity(telaJogo);
    }

    void proxPalavra(){
        Intent cenaT = new Intent(this, Cena1.class);

        if (fase == 2 || fase == 4 || fase == 6){
            cenaT.putExtra("cena", fase+1);
            finish();
            startActivity(cenaT);
        } else if (palavra < 5) {
            Intent telaJogo = getIntent();
            telaJogo.putExtra("palavra",palavra+1);
            telaJogo.putExtra("fase",fase);
            finish();
            startActivity(telaJogo);
        } else if (palavra == 5){
            cenaT.putExtra("cena", fase+1);
